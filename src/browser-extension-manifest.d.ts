...
export interface JSONSchemaForGoogleChromeExtensionManifestFiles {
  ...
  /**
   * Control the behaviour of the script badge.
   */
  script_badge?: {
    /**
     * Tooltip for the script badge's icon
     */
    default_title?: string;
    /**
     * The html document to be opened as a popup when the user clicks on the script badge's icon.
     */
    default_popup?: string;
  };
  /**
   ...
   */
  web_accessible_resources?: [Icon, ...Icon[]];
